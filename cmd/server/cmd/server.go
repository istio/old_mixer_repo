...
func serverCmd(info map[string]template.Info, adapters []handlers.InfoFn, printf, fatalf shared.FormatFn) *cobra.Command {
	sa := &serverArgs{}
...
func runServer(sa *serverArgs, info map[string]template.Info, adapters []handlers.InfoFn, printf, fatalf shared.FormatFn) {
