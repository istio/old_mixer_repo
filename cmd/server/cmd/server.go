...
func serverCmd(printf, fatalf shared.FormatFn) *cobra.Command {
	...
	serverCmd.PersistentFlags().IntVarP(&sa.expressionEvalCacheSize, "expressionEvalCacheSize", "", 1024, "Size of the cache that caches the expressions "+
		"in the config for faster evaluation of requests")
