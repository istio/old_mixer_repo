...
func crdCmd(tmplInfos map[string]template.Info, adapters []handlers.InfoFn, printf, fatalf shared.FormatFn) *cobra.Command {
...
func listCrdsAdapters(printf, fatalf shared.FormatFn, infoFns []handlers.InfoFn) {
