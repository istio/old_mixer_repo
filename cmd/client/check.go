...
func checkCmd(rootArgs *rootArgs, errorf func(format string, a ...interface{})) *cobra.Command {
...
func check(rootArgs *rootArgs, args []string, errorf func(format string, a ...interface{})) {
