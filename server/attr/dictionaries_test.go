...
func TestCompareDictionary(t *testing.T) {
	...
	cases := []testCase{
		testCase{make(dictionary), nil, true},
		testCase{make(dictionary), make(dictionary), true},
		testCase{dictionary{1: "1"}, nil, false},
		testCase{dictionary{1: "1"}, dictionary{1: "1"}, true},
		testCase{dictionary{1: "1"}, dictionary{1: "2"}, false},
		testCase{dictionary{1: "1"}, dictionary{2: "1"}, false},
		testCase{dictionary{1: "1"}, dictionary{2: "2"}, false},
		testCase{dictionary{1: "1"}, dictionary{1: "1", 2: "1"}, false},
	}
