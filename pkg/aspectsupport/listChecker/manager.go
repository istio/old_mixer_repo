...
import (
	...
	listcheckerpb "istio.io/api/mixer/v1/config/aspect"
...
type (
	...
	aspectWrapper struct {
		...
		aspectConfig *listcheckerpb.ListCheckerConfig
	}
)
...
func (m *manager) NewAspect(cfg *aspectsupport.CombinedConfig, ga aspect.Adapter, env aspect.Env) (aspectsupport.AspectWrapper, error) {
	...
	var aspectConfig *listcheckerpb.ListCheckerConfig
