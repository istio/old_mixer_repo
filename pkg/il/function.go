...
type Function struct {
	// Name is the name of the function. It needs to be globally unique.
	Name string

	// Parameters is the type of the input parameters to function.
	Parameters []Type
...
// FunctionsTable contains a set of functions, organized by the id of the string corresponding to
// their name.
