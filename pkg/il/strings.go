...
// StringsTable is a table that maps uint32 ids to strings and allows efficient storage of strings in IL.
...
// newStringsTable creates a new StringsTable.
...
func (t *StringsTable) GetID(s string) uint32 {
...
func (t *StringsTable) TryGetID(s string) uint32 {
	id, exists := t.stringToID[s]
	if !exists {
		return 0
	}
...
func (t *StringsTable) GetString(id uint32) string {
