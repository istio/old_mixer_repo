...
// Get the set of attributes that have been referenced through this bag.
func (pb *ProtoBag) GetReferencedAttributes() mixerpb.ReferencedAttributes {
...
// Clears the list of referenced attributes being tracked
