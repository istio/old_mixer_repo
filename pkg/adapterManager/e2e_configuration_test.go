...
func GetFakeHndlrBuilderInfo() handlers.Info {
...
func testConfigFlow(t *testing.T, declarativeSrvcCnfgFilePath string, declaredGlobalCnfgFilePath string) {
	...
	cnfgMgr := config.NewManager(eval, adapterMgr.AspectValidatorFinder, adapterMgr.BuilderValidatorFinder, []handlers.InfoFn{GetFakeHndlrBuilderInfo},
