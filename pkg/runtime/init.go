...
func New(eval expr.Evaluator, gp *pool.GoroutinePool, handlerPool *pool.GoroutinePool,
	...
	s store.Store2, adapterInfo map[string]*handlers.Info,
...
func startWatch(s store.Store2, adapterInfo map[string]*handlers.Info,
...
func kindMap(adapterInfo map[string]*handlers.Info,
...
func startController(s store.Store2, adapterInfo map[string]*handlers.Info,
