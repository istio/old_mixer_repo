...
go_metalinter() {
    ...
    gometalinter\
        ...
        --enable=gofmt\
        --enable=goimports\
        --enable=golint --min-confidence=0 --exclude=.pb.go --exclude=pkg/config/proto/combined.go --exclude=pkg/templates/sample/report/ReportTesterProcessor.gen.go --exclude="should have a package comment"\
