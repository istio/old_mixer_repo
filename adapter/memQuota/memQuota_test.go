...
func TestAllocAndRelease(t *testing.T) {
	...
	c.MinDeduplicationWindow = &duration.Duration{Seconds: 3600}
...
func TestBadConfig(t *testing.T) {
	...
	c.MinDeduplicationWindow = &duration.Duration{}
	if err := b.ValidateConfig(c); err == nil {
		t.Errorf("Expecting failure, got success")
	}

	c.MinDeduplicationWindow = &duration.Duration{Seconds: 0x7fffffffffffffff, Nanos: -1}
	if err := b.ValidateConfig(c); err == nil {
		t.Errorf("Expecting failure, got success")
	}
}
