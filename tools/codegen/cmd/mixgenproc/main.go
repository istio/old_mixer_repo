...
func withArgs(args []string, errorf func(format string, a ...interface{})) {
	...
	rootCmd := cobra.Command{
		...
		Short: "Tool that parses a [Template](http://TODO) and generates Go interface for adapters to implement.",
		Long: "If the adapter want to process a particular [Template](http://TODO), it should implement the Go interface " +
